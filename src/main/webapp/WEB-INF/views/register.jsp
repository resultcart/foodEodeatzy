		...
		<div class="col-lg-12">
			<div class="page-title-item text-center">
				...
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item active" aria-current="page">Personal/Bussiness</li>
				</ol>
				</nav>
			</div>
		</div>
        ...
        <div class="flex flex-col overflow-y-auto md:flex-row">
          <div class="h-32 md:h-auto md:w-1/2">
            <img aria-hidden="true"
              ...
              src="${assets_wPath}/img/login-office.jpeg"
              alt="Office"/>
            <img aria-hidden="true"
              class="hidden object-cover w-full h-full dark:block"
              src="${assets_wPath}/img/login-office-dark.jpeg"
              alt="Office"/>
          </div>
          <div class="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
           ...
           <hr>
              <!-- You should use a button here, as the anchor is only used for the example  -->
                <br><br><br>
               <a class="btn btn-outline-warning btn-fw" href="${contextPath }/login/ins_mem_u">
                개인사용자 회원가입
              </a>
