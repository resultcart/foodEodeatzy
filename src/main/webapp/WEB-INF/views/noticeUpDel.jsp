            ...
            <form role="form" name="f" method="post" onsubmit="return validate();">
				...
				<div class="box-body">
					<div class="form-group">
						...
						<input type="hidden" name="b_id" id="b_id" value= ${notice.b_id} class="form-control"   />
						<label>제목</label><input type="text" name="b_title" id="b_title" value= ${notice.b_title} class="form-control"   />
						<label>내용</label>
						<textarea type="text" name="b_content" id="b_content" class="form-control" rows="10">${notice.b_content}</textarea>
					</div>
				</div>
				</div>
			</form>
