                    ...
                    <div class="page-title-item text-center">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">busi - Login</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                                ...
                                <div class="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
                                    <div class="w-full">
                                        ...
                                        <label class="block text-sm">
                                            ...
                                            <input type="text" name="u_b_id" placeholder="id를 입력하세요" value="${login.u_b_id}" onKeyDown="if(event.keyCode == 13) loginChk()"
                                            	   class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"/>
                                        </label>
                                        <label class="block mt-4 text-sm">
                                            <span class="text-gray-700 dark:text-gray-400">Password</span>
                                             <input type="password" name="u_b_pw" placeholder="pw를 입력하세요" value="${login.u_b_pw}" onKeyDown="if(event.keyCode == 13) loginChk()"
                                           		    class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"/>
                                        </label>
                                        ...
                                        <script>
											...
											var form = document.f1;
												if (!form.u_b_id.value) {
													alert("아이디를 입력해 주십시오.");
													form.u_b_id.focus();
												return;
												}
												if (!form.u_b_pw.value) {
