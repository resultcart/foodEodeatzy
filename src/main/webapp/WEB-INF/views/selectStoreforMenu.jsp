			...
			<div class="blog-details mt-30 mr-20">
				...
				<div class="blog-details-form">
					<div class="blog-details-title">
						<h2 class="title">메뉴를 조회할 가게를 선택해 주세요.</h2>
					</div>				
					...
					<hr>	
						<div class="col-lg-12">
								<div class="food-menu-box">
									<div class="row grid">
										<c:forEach items="${selectStoreforMenu}" var="selectStoreforMenu">
													...
													<div class="food-menu-item mt-50 d-block d-sm-flex align-items-center" >
														<div class="col-lg-8">
															<div class="food-menu-content">
																 	...
																 	<h4 name="s_name" value="${selectStoreforMenu.s_name}">${selectStoreforMenu.s_name}</h4>
																 	가게 아이디 : ${selectStoreforMenu.u_s_id } -> 수정시 필수 확인*
																<ul>
																	<li name="s_desc"> 가게 메모 : ${selectStoreforMenu.s_desc}</li>
														...
														<div class="col-lg-5">
															...
															<a href="selectMenu?u_b_id=${selectStoreforMenu.u_b_id}&u_s_id=${selectStoreforMenu.u_s_id }">조회</a>
															</div>
														</div>	
													</div>
