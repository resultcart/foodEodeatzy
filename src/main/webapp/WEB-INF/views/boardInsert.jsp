...
<div class="container">
	<div class="row justify-content-center">
		<div class="col-lg-16">
			...
			<form name="fm" method="POST" action="${contextPath}/board/boardInsert">
			    <div class="box" id="sht_board_dtl">
				<div class="box-header">
					<h4 class="box-title">제보게시판 등록</h4>
				</div>
				<div class="box-body">
					<div class="form-group">
						<label>제목</label><input type="text" name="b_title" id="b_title" class="form-control"   />
						<label>내용</label><textarea type="text" name="b_content" id="b_content" class="form-control" rows="10"></textarea>
